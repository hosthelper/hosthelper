...
const ASSET_VERSION = process.env.HELPER_OFFICE_ASSET_VERSION || '20260912-p0-3';
...
async function verifyOfficialProduction() {
  ...
  if(!p0.includes('p0-hardening-v1-20260912'))throw new Error('PRODUCTION_P0_HARDENING_VERSION_MISMATCH');
  return{official_url:OFFICIAL_URL,asset_version:ASSET_VERSION,index_markers_verified:markers.length,runtime_status_verified:true,session_recovery_verified:true,p0_hardening_verified:true,realtime_sdk_injected:true};
}
